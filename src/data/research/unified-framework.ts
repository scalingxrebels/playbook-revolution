  ...
  practicalApplication: {
    ...
    applications: [
      ...
      },
      {
        ...
        cta: { text: { en: 'Build Roadmap', de: 'Roadmap erstellen' }, href: 'https://cal.scalingx.io/inflection-call' },
        color: 'blue'
      },
      {
        number: 3,
        ...
        cta: { text: { en: 'Track Progress', de: 'Fortschritt verfolgen' }, href: 'https://cal.scalingx.io/inflection-call' },
        color: 'emerald'
      }
    ]
  },
