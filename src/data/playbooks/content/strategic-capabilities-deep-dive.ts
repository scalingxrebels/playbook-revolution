...
const meta = getPlaybookBySlug('strategic-capabilities/deep-dive')!;

export const strategicCapabilitiesDeepDiveData: PlaybookPageData = {
  meta,
  hero: {
    breadcrumb: { en: "Playbooks", de: "Playbooks" },
    badge: { en: "Deep Dive", de: "Deep Dive" },
    title: "Strategic Capabilities Deep Dive",
    subtitle: { en: "...", de: "..." },
    description: { en: "...", de: "..." },
    trustBadges: [],
    bookingUrl: "#",
