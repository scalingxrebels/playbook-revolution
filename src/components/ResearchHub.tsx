...
const researchCards: ResearchCard[] = [
  ...
  },
  {
    ...
    descriptionDe: 'Wir haben eine vollständige Formel entwickelt, die 76% der Varianz in der Skalierungsgeschwindigkeit erklärt: Scaling Success = Markt × Enablers × Capabilities × AI Maturity. Validiert mit n=22 AI-native Unternehmen.',
