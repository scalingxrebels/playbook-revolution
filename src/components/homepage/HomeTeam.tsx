        ...
        >
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed max-w-xl mb-3 whitespace-pre-line">
              {language === 'de'
                ? 'SaaS von €3,3M auf €10,2M ARR gebracht — in 2 Jahren.\n\n19 Jahre B2B SaaS GTM, als Operator, nicht Berater. Baut den Mechanismus. Autor „Fix Growth. Scale Faster."'
                : 'Scaled SaaS from €3.3M to €10.2M ARR — in 2 years.\n\n19 years B2B SaaS GTM, as an operator, not a consultant. Builds the mechanism. Author "Fix Growth. Scale Faster."'}
            </p>
