  ...
  return (
    ...
    >
      ...
      <div className="container max-w-5xl mx-auto px-6 relative z-10">
        ...
        {/* Comparison Table */}
        <div
          className={`w-full overflow-x-auto rounded-xl border-2 border-border/50 className={`w-full overflow-x-auto rounded-xl border-2 border-border/50 bg-card transition-all duration-700 ${ duration-700 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
